...
<iframe
  ...
  src="https://www.youtube.com/embed/fvf7oLcSxWg"
...
- **Plug-and-play**: Run a task in just 1 line of code using high-level methods or dive deep with sessions.
...
- **Browser Profiles**: Maintain state across multiple tasks and sessions to preserve cookies and authentication.
