...
Allows the agent to take screenshots of the browser viewport. The acquired screenshots can be accessed via the `.downloads_url` attribute of the task result.
