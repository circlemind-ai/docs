...
<ResponseField name="downloads_url()" type="method">
  Waits for the task completion and returns a URL of the archive containing the files downloaded during the execution. If no file was downloaded raises ApiError(404).
</ResponseField>
