...
<ResponseField name="profile_id()" type="method">
  Returns the ID of the profile used in the session.
</ResponseField>

<ResponseField name="live_url()" type="method">
  Returns a live URL where you can interact with the browser.
...
While context managers are recommended, you can also close sessions manually.
