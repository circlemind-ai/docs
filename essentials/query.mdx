...
**Note: in the current Beta version, added memories may not be available for querying for up to 10 minutes after adding them for the first time (eventually consistent). We will release an update that will eliminate this limitation on October the 26th. Ingestion will be instantaneous.** If you would like to request earlier access to this new feature, reach out at `support@circlemind.co`.   
